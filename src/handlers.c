...
show_about_popup (GtkMenuItem* about_menu_item, gpointer user_data)
{
    ...
    const gchar* comments = "A card game written in C and Gtk+";
    ...
    gtk_about_dialog_set_website (GTK_ABOUT_DIALOG(dialog), "http://unwlelt.itch.io/gPlead");//"https://github.com/Pyr0x1/gPlead");
